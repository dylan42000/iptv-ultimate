...
private data class RailItem(val section: AppSection, val label: String, val icon: ImageVector)
...
fun CollapsingNavRail(
    ...
    androidx.compose.foundation.layout.Column(
        modifier = modifier
            .width(width)
            .fillMaxHeight()
            .background(Brush.verticalGradient(listOf(CinematicSurface, CinematicSurface.copy(alpha = 0.4f)))),
...
private fun RailButton(
    ...
    Row(
        modifier = Modifier
            ...
            .then(Modifier.tvFocus(scale = 1.06f, ringWidth = 2.dp))
            .clickable(
